...
namespace TrainingApp.Data.Migrations
{
    ...
    [Migration("20250509114333_workflowEnginAndhistory")]
    partial class workflowEnginAndhistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainingApp.Data.Models.Workflow.WorkflowConfiguration", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TrainingApp.Data.Models.Workflow.WorkflowConfigurationStep", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkflowConfigurationSteps");
                });

            modelBuilder.Entity("TrainingApp.Data.Models.Workflow.WorkflowEngine", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TrainingApp.Data.Models.Workflow.WorkflowStateHistory", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkflowStateHistory");
                });
            ...
            modelBuilder.Entity("TrainingApp.Data.Models.Workflow.WorkflowConfigurationStep", b =>
                {
                    b.HasOne("TrainingApp.Data.Models.Workflow.WorkflowConfiguration", "WorkflowConfiguration")
                        .WithMany("StepsList")
                    ...
                    b.Navigation("WorkflowConfiguration");
                });
            ...
            modelBuilder.Entity("TrainingApp.Data.Models.Workflow.WorkflowStateHistory", b =>
                {
                    b.HasOne("TrainingApp.Data.Models.Workflow.WorkflowEngine", "Engine")
                        .WithMany()
